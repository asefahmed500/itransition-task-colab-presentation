...
interface CreatePresentationButtonProps extends ButtonProps {
  children?: React.ReactNode
}

export function CreatePresentationButton({ children, ...props }: CreatePresentationButtonProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button {...props}>{children || "Create Presentation"}</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle>Create new presentation</DialogTitle>
            <DialogDescription>Create a new presentation to share with your team.</DialogDescription>
          </DialogHeader>
